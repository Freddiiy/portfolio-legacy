    ...
    >
      <div className="flex text-center items-center justify-center text-lg">
        ...
        <span className={"relative inline flex items-center group ml-1 w-12"}>
			<span className={"w-12 absolute inline opacity-100 group-hover:opacity-0 translate-y-0 group-hover:-translate-y-4 transition-all duration-100"}>
				Copenhagen
			</span>
			<span className={"w-12 absolute inline opacity-0 group-hover:opacity-100 translate-y-4 group-hover:translate-y-0 transition-all duration-100"}>
				Warde
			</span>
		</span>
      </div>
