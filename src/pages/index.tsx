...
import WaveSVG from "../components/PageTransition/WaveSVG";
...
function Features() {
	return (
		<>
			<div
				className={"container mx-auto flex grid lg:grid-cols-3 justify-center"}
			>
				<FeatureCard
	...
	return (
		<>
			...
			<div className="w-full bg-white">
				<h3 className="text-center text-black font-bold text-xl">Skills</h3>
			</div>
		</>
	);
}
